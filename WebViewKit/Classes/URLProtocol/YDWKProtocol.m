...
+ (BOOL)canInitWithRequest:(NSURLRequest *)request {
    ...
    if ([request.URL.absoluteString caseInsensitiveCompare:kYDWebViewReuseUrlString] == NSOrderedSame) {
        return YES;
    }
...
- (NSString *)_getWebViewReuseLoadString{
    return @"<html><head><meta name=\"viewport\" " @"content=\"initial-scale=1.0,width=device-width,user-scalable=no\"/><title>YDWebKit-Reuse</title></head><body></body></html>";
}
