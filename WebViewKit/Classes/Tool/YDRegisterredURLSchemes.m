...
@implementation YDRegisterredURLSchemes
...
+ (void)registerURLSchemeModel:(NSArray <YDURLSchemeModel *>*)URLScheme
{
    NSMutableDictionary *contantDic = [NSMutableDictionary dictionary];
    
    for (YDURLSchemeModel *model in URLScheme) {
